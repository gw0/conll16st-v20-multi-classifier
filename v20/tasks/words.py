...
def encode_x_words(words_slice, words2id, words2id_size, max_len):
...
def encode_x_words_rand(words_slice, words2id, words2id_size, max_len):
...
def test_build_words():
    ...
    words2id, words2id_size = build_words2id(words, min_count=min_count)
...
def test_encode_x_words():
    ...
    x_0 = encode_x_words(words_slice, words2id, words2id_size, max_len_0)
    assert (x_0 == t_x_0).all()

    x_0_rand = encode_x_words_rand(words_slice, words2id, words2id_size, max_len_0)
    assert (x_0_rand == t_x_0).all()

    x_1 = encode_x_words(words_slice, words2id, words2id_size, max_len_1)
    assert (x_1 == t_x_1).all()

    x_1_rand = encode_x_words_rand(words_slice, words2id, words2id_size, max_len_1)
